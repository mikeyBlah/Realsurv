...
<meta charset="utf-8">
<head>
	<title>Realsurv - Engineering Surveyors - Contact</title>
	...
	<section class="pageWrap">
		...
		<div class="contentWrap">
			<div class="contactCard">
				<p class="boldish">0404940164</p>
				<p><span class="contBold">ADDRESS</span><br />15 Clifton St,<br />Prahan,<br />VIC,<br />3181</p>
				<p><span class="contBold">EMAIL</span><br />david@realsurv.com.au</p>
			</div>
			<div class="contactCard">
				<p class="contBold">CONTACT FORM</p>
				<form id="contactForm">
					<input class="formInput" type="text" placeholder="Name"/>
					<input class="formInput" type="text" placeholder="Email"/>
					<textarea class="formInput" rows="4" cols="50" placeholder="Message"></textarea>
				</form>
				<div class="btnBack">
					<button class="formBtn" type="submit" value="submit"></button>
				</div>
			</div>
